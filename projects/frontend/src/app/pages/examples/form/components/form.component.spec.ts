...
describe("FormComponent", () => {
  ...
  const getSaveButton = () => loader.getHarness(MatButtonHarness.with({ text: "pldb.examples.form.save" }));

  const getResetButton = async () => loader.getHarness(MatButtonHarness.with({ text: "pldb.examples.form.reset" }));
