...
export class TodosEffects {
  constructor(private actions$: Actions, private store: Store<State>, private localStorageService: LocalStorageService) {}

  persistTodos = createEffect(
    () =>
      this.actions$.pipe(
        ofType(todoAction.actionTodosAdd, todoAction.actionTodosFilter, todoAction.actionTodosRemoveDone, todoAction.actionTodosToggle),
