...
describe("BigInputActionComponent", () => {
  ...
  it("should be created", () => {
    const template = "<pldb-big-input-action></pldb-big-input-action>";
  ...
  it("should disable button if disabled property is set", () => {
    const template = '<pldb-big-input-action [disabled]="true"></pldb-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it("should display icon if fontSet and fontIcon properties are set", () => {
    const template = `<pldb-big-input-action fontSet="fas" fontIcon="fa-trash"></pldb-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it("should display label with provided text when label property is set", () => {
    const template = `<pldb-big-input-action label="delete"></pldb-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it("should emit action event on button click", () => {
    const template = `<pldb-big-input-action (action)="actionHandler()"></pldb-big-input-action>`;
    fixture = createHostComponent(template);
